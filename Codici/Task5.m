...
[M_outerLoop_C,Delta_outerLoop_C] = lftdata(outerLoop_C,{'Y_v';'L_v';'Y_delta';'L_delta'});
...
M_outerLoop_C=connect(R_phi_C,R_p_C,F_phi_n,F_p_n,Sum_phi,Sum_p,Sum_phi_n,Sum_p_n,W_phi,W_p,...
...
outerLoop_C_verifica=connect(Delta_phi,Delta_p,M_outerLoop_C,'phi_0',{'p','phi'});
figure(320)
hold on
